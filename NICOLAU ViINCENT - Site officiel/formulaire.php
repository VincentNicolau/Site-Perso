...
$destinataire = 'vincent.nicolau@live.fr';

// copie ? (envoie une copie au visiteur)
$copie = 'oui'; // 'oui' ou 'non'
// Messages de confirmation du mail
$message_envoye = "Votre message m'a bien été parvenu !";
...
if (!isset($_POST['envoi'])) {
    ...
    if (($nom != '') && ($email != '') && ($objet != '') && ($message != '')) {
        ...
        if ((($copie == 'oui') && ($num_emails == 2)) || (($copie == 'non') && ($num_emails == 1))) {
            echo '<p>' . $message_envoye . ' <a href="index.html">Retour</a></p>';
        } else {
            echo '<p>' . $message_non_envoye . ' <a href="index.html">Retour</a></p>';
        }
    } else {
